...
def create_benchmark(
    db: Session, benchmark: schemas.BenchmarkCreate, device_id: int
) -> models.Benchmark:
    """
    ...
    db_benchmark = models.Benchmark(**benchmark.dict(), device_id=device_id)
...
def get_benchmark_by_device(db: Session, device_id: int):
    ...
    return (
        ...
        .filter(models.Benchmark.device_id == device_id)
        .first()
    )
