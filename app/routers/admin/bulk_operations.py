...
async def bulk_update_category(
    ...
    try:
        ...
        return RedirectResponse(
            url="/admin/bulk-operations?error=Failed to update devices", status_code=303
        )
...
async def bulk_update_price(
    ...
    try:
        ...
        return RedirectResponse(
            url="/admin/bulk-operations?error=Failed to update prices", status_code=303
        )
